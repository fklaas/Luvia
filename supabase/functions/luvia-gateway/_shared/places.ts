...
if(action==='places.health'){result={status:'ok',service:'google-places-gateway',version:'3.0.2.11',configured:Boolean(getKey()),metrics:{...metrics},cache:{entries:cache.size}};return{data:result,cache:{hit:false,key:null,ttlMs:0}};}
