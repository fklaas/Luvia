(() => {
  ...
  const VERSION = '4.28.6.1';
  const BUILD = '13.28.6.1';
  ...
  function editorControls(edit) {
    ...
    <div class="lv-studio-drawer is-open" data-studio-drawer>
      <header><strong data-drawer-title>Looks</strong><button type="button" data-drawer-close>×</button></header>
