(() => {
  ...
  function handleHubAction(action){
    if(!action)return;
    if(['today','plan','trip','memories','more','places','places-lifecycle','routes','gallery','albums'].includes(action))return show(action);
