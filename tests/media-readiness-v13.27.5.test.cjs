...
assert(svc.includes("const VERSION='4.27.5.1'"),'Media Readiness version missing');
...
assert(index.includes('core/diagnostics/media-readiness.js?v=13.27.5.1'),'app load missing');
assert(consoleHtml.includes('../core/diagnostics/media-readiness.js?v=13.27.5.1'),'console load missing');
...
console.log('Media readiness 13.27.5.1 static integration: OK');
