...
const build='13.11.0.1',core='4.11.0.1';
const must=[
 ['intelligence/kernel/version.js',build,core,'Cycling Registry Bootstrap & Asset Loading Fix'],
 ...
 ['intelligence/runtime-config.json',build,core,'Cycling Registry Bootstrap & Asset Loading Fix'],
 ...
 ['RELEASE-v13.11.0.1.md',build,core],
 ['DEPLOYMENT-v13.11.0.1.md',build],
 ['TEST-v13.11.0.1.md',build],
 ['CHANGED-FILES-v13.11.0.1.txt',build,core],
 ['COMMIT-v13.11.0.1.txt','fix(places): register cycling routes in the global runtime'],
 ['00_UNBEDINGT_IMMER_LESEN_PLACES_ARCHITEKTUR.md','Build 13.11.0.1','Core 4.11.0.1']
];
const failures=[];
