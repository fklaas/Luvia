...
const build='13.18.0',core='4.18.0';
const read=f=>fs.readFileSync(f,'utf8');
for(const [f,needles] of Object.entries({
 'intelligence/kernel/version.js':[build,core,'Journey Knowledge Graph'],
 'sw.js':['luvia-shell-v13.18.0'],
 'index.html':['journey-knowledge-graph.js','ai-orchestrator.js',build],
...
console.log('Build 13.18.0 release and architecture consistency: OK');