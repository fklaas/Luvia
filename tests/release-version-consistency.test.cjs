...
const build='13.12.0',core='4.12.0';
const must=[
 ['intelligence/kernel/version.js',build,core,'Trailforks Hybrid Cycling Discovery & Partner Deep Links'],
 ...
 ['supabase/functions/luvia-gateway/_shared/cycling.ts',core,'cycling.search.generated','OPENROUTESERVICE_API_KEY','generated_round_trip','cycling.details'],
 ['supabase/migrations/20260730_036_core_v4_11_0_cycling_route_place_type.sql','4.11.0',"'cycling_route'"],
 ['intelligence/runtime-config.json',build,core,'Trailforks Hybrid Cycling Discovery & Partner Deep Links'],
 ...
 ['RELEASE-v13.12.0.md',build,core],
 ['DEPLOYMENT-v13.12.0.md',build],
 ['TEST-v13.12.0.md',build],
 ['CHANGED-FILES-v13.12.0.txt',build,core],
 ['COMMIT-v13.12.0.txt','feat(cycling): add Trailforks hybrid discovery and partner deep links'],
 ['00_UNBEDINGT_IMMER_LESEN_PLACES_ARCHITEKTUR.md','Build 13.12.0','Core 4.12.0']
];
const failures=[];
