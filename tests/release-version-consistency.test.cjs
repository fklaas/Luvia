...
const build='13.11.2',core='4.11.2';
const must=[
 ['intelligence/kernel/version.js',build,core,'Cycling Discovery Provider Rebuild & Reliable Results'],
 ...
 ['intelligence/runtime-config.json',build,core,'Cycling Discovery Provider Rebuild & Reliable Results'],
 ...
 ['RELEASE-v13.11.2.md',build,core],
 ['DEPLOYMENT-v13.11.2.md',build],
 ['TEST-v13.11.2.md',build],
 ['CHANGED-FILES-v13.11.2.txt',build,core],
 ['COMMIT-v13.11.2.txt','fix(cycling): rebuild staged route and trail discovery'],
 ['00_UNBEDINGT_IMMER_LESEN_PLACES_ARCHITEKTUR.md','Build 13.11.2','Core 4.11.2']
];
const failures=[];
