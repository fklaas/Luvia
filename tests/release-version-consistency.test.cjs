...
const must=[
 ...
 ['RELEASE-v13.9.0.md',build,core],
 ['DEPLOYMENT-v13.9.0.md',build],
 ['TEST-v13.9.0.md',build],
 ['00_UNBEDINGT_IMMER_LESEN_PLACES_ARCHITEKTUR.md','Build 13.9.0','Core 4.9.0']
];
const failures=[];
