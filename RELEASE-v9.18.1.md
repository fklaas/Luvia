# Luvia v9.18.2 — Intelligence Core v2.11.0 Places Gateway Auth Maintenance
...
- Edge Gateway: `2.11.0`
- PWA Cache: `luvia-shell-v9.18.2`


## Maintenance-Korrektur 9.18.2

- Platform-Diagnosetest vergleicht nun korrekt gegen Core `2.11.0` statt gegen die veraltete Kennung `2.9.0`.
- Platform-Build-Metadaten wurden auf Places Gateway aktualisiert.
- Der Standard-Feature-Flag `places` ist nun auch ohne geladene Runtime-Konfiguration korrekt aktiviert.
- Cache- und Asset-Versionen wurden auf Build `9.18.2` erhöht.
