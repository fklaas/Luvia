...
window.LuviaMemoryCards=Object.freeze({version:VERSION,build:BUILD,list,save,setWeight,dismiss,members,setAlbumReview,albumReviews,albumReviewSummary,albumVotes,saveAlbumVotes,syncPhotoCandidates,curationClass,stackCuration,saveTitleProposal,dissolveStack,subscribe,subscribeIdentities,tripAccent,activeTrip,isWriting:()=>writeDepth>0});
})();
