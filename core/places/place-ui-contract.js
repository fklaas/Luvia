...
function forType(type){const c=window.LuviaPlaceTypeContracts?.get?.(type)||{};return Object.freeze({version:VERSION,type,card:{factSlots:[...(c.ui?.card?.factSlots||FACT_SLOTS)]},detail:{providerFields:'allAvailable',sectionOrder:[...(c.ui?.detail?.sectionOrder||DETAIL_ORDER)],hiddenSections:[...(c.ui?.detail?.hiddenSections||HIDDEN)],requiredSections:[...(c.ui?.detail?.requiredSections||['alternatives'])]}})}
