(() => {
  ...
  function create(){
    ...
    client=factory(c.url,key,{auth:{persistSession:true,autoRefreshToken:true,detectSessionInUrl:true,flowType:'pkce'},global:{headers:{'x-client-info':'luvia/11.7.0'}}});
