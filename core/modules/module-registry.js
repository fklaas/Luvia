(() => {
  ...
  const entries=[
    ...
    {id:'shopping',title:'Shopping',longTitle:'Shopping & besondere Geschäfte',icon:'🛍️',description:'Märkte, Boutiquen, Souvenirs und besondere Einkaufsorte entdecken und planen.',status:'available',defaultEnabled:true,order:11},
    {id:'restaurants',title:'Restaurants',longTitle:'Restaurants & Reservierungen',icon:'🍽️',description:'Restaurants entdecken, speichern und Reservierungen planen.',status:'available',defaultEnabled:true,order:12},
  ...
  window.LuviaModuleRegistry=Object.freeze({version:'4.10.0',list,get,normalize,enabledForTrip,isEnabled,updateTripModules});
})();
