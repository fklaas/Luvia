(() => {
  ...
  window.LuviaModuleRegistry=Object.freeze({version:'4.16.1',list,get,normalize,enabledForTrip,isEnabled,updateTripModules,domains:Object.freeze({places:CORE_PLACE_MODULES,move:CORE_MOVE_MODULES})});
})();
