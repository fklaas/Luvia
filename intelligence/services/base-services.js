  ...
  async function ensureRecommendationApi(){
    ...
    recommendationLoadPromise=(async()=>{
      if(!window.LuviaRecommendations){
        await loadScriptOnce(recommendationScriptUrl('core/recommendations/recommendation-service.js?v=12.0.0'),'luvia-recommendation-service');
      }
      ...
      if(!adapters.includes('restaurants')){
        await loadScriptOnce(recommendationScriptUrl('core/recommendations/restaurant-recommendation-adapter.js?v=12.0.0'),'luvia-recommendation-adapter');
      }
