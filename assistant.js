(function(){
  ...
  function content(d,c){
    ...
    const evening=h>=18;
    const title=anniversary?'Heute vor einem Jahr habt ihr Ja gesagt. ❤️':key==='2026-08-02'?'Die letzten Stunden ganz bewusst genießen.':evening?'Paris leuchtet heute nur für euch.':'Guten Morgen! Ein neuer Reisetag wartet auf euch.';
